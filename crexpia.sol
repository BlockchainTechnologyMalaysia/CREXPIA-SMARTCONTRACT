...
/**
 * The contract controls the ownership and transfer of CRE tokens.
...
contract CrexpiaTokenInterface is ERC20 {
  bool public freeze;
  function burn(uint256 _value) public;
...
contract CrexpiaToken is CrexpiaTokenInterface, UpgradeableToken, DetailedERC20, BurnableToken, Pausable {
  using SafeMath for uint256;
